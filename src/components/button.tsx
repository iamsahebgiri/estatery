...
export function buttonClasses({
  ...
  return classNames(
    ...
    variant === "primary" &&
      "border-transparent text-white bg-violet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500",
    variant === "primary" && !isLoading && "hover:bg-violet-700",
    variant === "secondary" && "border-violet-200 border-2 text-violet-700 bg-white ",
